...
import com.shi.api.model.PmsProductExample.Criteria;
import com.shi.api.model.PmsProductExample.Criterion;
import com.shi.api.model.PmsProductExample;
import com.shi.api.model.PmsProductWithBLOBs;
...
public class PmsProductSqlProvider {
    ...
    public String insertSelective(PmsProductWithBLOBs record) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        PmsProductWithBLOBs record = (PmsProductWithBLOBs) parameter.get("record");
    ...
    public String updateByPrimaryKeySelective(PmsProductWithBLOBs record) {
        SQL sql = new SQL();
        sql.UPDATE("pms_product");
